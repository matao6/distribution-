...
<head>
    ...
    <link rel="stylesheet" href="/Public/Admin/css/memberlisthtml.css">
</head>
<body class="body-wrapper">
    ...
    <div class="content clearfix">
        ...
        <div class="info">
            <div class="title">
                <p class="text content-right-title">管理员</p>
            </div>
            <div class="add">
                <a href="javascript:;" class="btn btn-success add_admin-hook">添加管理员</a>
            </div>
            <div class="search">
                <form action="" method="post">
                    <select class="select group-hook">
                        <option value="">--请选择--</option>
                        <?php if(is_array($group)): foreach($group as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                    </select>
                    <input type="text" class="input linkman-hook" placeholder="联系人">
                ...
                <table class="wxtables mgt15 table-hook">
                    ...
                    <tbody>
                        <!-- <tr>
                            ...
                            <td>test</td>
                            <td>
                                <a href="#" class="btn btn-mini btn-primary edit">编辑</a>
                                <a href="#" class="btn btn-mini btn-danger adminListDelete">删除</a>
                            </td>
                        </tr> -->
                    </tbody>
                </table>
	...
	<script type="text/javascript" src="/Public/Admin/js/memberlisthtml.js"></script>
</body>
</html>