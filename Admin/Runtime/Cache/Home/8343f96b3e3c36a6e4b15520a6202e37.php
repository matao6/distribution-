...
<body class="body-wrapper">
                    ...
                    <div class="m_formPart">
                        ...
                        <div class="form-controls">
                            <select class="select" name="store_id">
                                ...
                                <?php if(is_array($store)): foreach($store as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-controls">
	...
	<script type="text/javascript" src="/Public/Admin/js/memberAddHtml.js"></script>
</body>
</html>