            ...
            <form action="" id="form-hook">
                ...
                <div class="add_role_box">
                    <div class="add_role_list">
                        ...
                        <ul>
                            <?php if(is_array($y)): foreach($y as $key=>$v): if(is_array($v['list'])): foreach($v['list'] as $key=>$vo): if(is_array($vo['list'])): foreach($vo['list'] as $key=>$val): ?><li class="menu_li">
                                            <input type="checkbox" class="" id="<?php echo ($val["id"]); ?>" name="pid"><label for="<?php echo ($val["id"]); ?>"><?php echo ($val["name"]); ?></label>
                                        </li><?php endforeach; endif; endforeach; endif; endforeach; endif; ?>
                        </ul>
                    </div>
                    <div class="add_role_list">
                        <div class="">
